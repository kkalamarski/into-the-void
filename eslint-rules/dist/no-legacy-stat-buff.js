...
export const noLegacyStatBuff = ESLintUtils.RuleCreator.withoutDocs({
    create(context) {
        return {
    ...
    meta: {
        ...
        messages: {
            noLegacyStatBuff: "Use 'stats' effect type instead of stat_buff with duration: 0. " +
