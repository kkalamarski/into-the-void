# Requirements Archive: v1.20 World Scale & Action Bar
...
- [x] **WORLD-01**: Biomes are small enough that players can reach neighboring biomes in 2-3 minutes of walking
- [x] **WORLD-02**: Biome transitions remain natural and gradual (no jarring edges)
...
- [x] **ABAR-01**: Clicking ability icon triggers the ability
- [x] **ABAR-02**: SHIFT + drag allows relocating ability within action bar
- [x] **ABAR-03**: Abilities can be dragged from abilities panel to action bar
- [x] **ABAR-04**: Dropping ability outside action bar removes it
- [x] **ABAR-05**: Second action bar with 8 slots exists below/beside first bar
- [x] **ABAR-06**: Second bar uses Shift+1-8 keybindings

### HUD

- [x] **HUD-01**: Game shortcuts are smaller
- [x] **HUD-02**: Game shortcuts moved to bottom-right next to minimap
- [x] **HUD-03**: Freed space accommodates second action bar
...
|-------------|-------|--------|
| WORLD-01 | Phase 94 | Complete |
| WORLD-02 | Phase 94 | Complete |
| TRAV-01 | Phase 95 | Complete |
| TRAV-02 | Phase 95 | Complete |
| TRAV-03 | Phase 95 | Complete |
| TRAV-04 | Phase 96 | Complete |
| TRAV-05 | Phase 96 | Complete |
| ABAR-01 | Phase 97 | Complete |
| ABAR-02 | Phase 97 | Complete |
| ABAR-03 | Phase 97 | Complete |
| ABAR-04 | Phase 97 | Complete |
| ABAR-05 | Phase 98 | Complete |
| ABAR-06 | Phase 98 | Complete |
| HUD-01 | Phase 98 | Complete |
| HUD-02 | Phase 98 | Complete |
| HUD-03 | Phase 98 | Complete |
