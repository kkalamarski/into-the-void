...
- [ ] **Phase 147: EntityRenderer Strategy** - Replace per-type switch logic in EntityRenderer with dedicated strategy classes per entity type
...
|-------|----------------|--------|-----------|
| 147. EntityRenderer Strategy | 0/TBD | Not started | - |
