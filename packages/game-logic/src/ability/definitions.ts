...
export const ABILITY_ELECTROCUTE: AbilityDefinition = {
  ...
  description: 'Discharge high-voltage energy that arcs between targets. Shock damage spreads to creatures within 2 tiles.',
  category: 'offensive',
  energyCost: 20,
  cooldownMs: 6000,
  range: 2,
  ...
  effects: [
    ...
    { type: 'dot', damagePerTick: 5, tickInterval: 1000, duration: 4000, spreadRadius: 2 },
  ],
...
export const ABILITY_CONCUSSIVE_STRIKE: AbilityDefinition = {
  ...
  description: 'Deliver a powerful strike that stuns the target for 1 second. Stuns maniacs for 3 seconds.',
  category: 'offensive',
  energyCost: 18,
  cooldownMs: 5000,
  range: 1,
  ...
  effects: [
    ...
    { type: 'stun', durationMs: 1000, maniacDurationMs: 3000 },
  ],
...
export const ABILITY_THERMAL_LANCE: AbilityDefinition = {
  ...
  description: 'Project a focused beam of intense heat. Deals Thermal damage, effective against cold-adapted creatures.',
  category: 'offensive',
  energyCost: 22,
  cooldownMs: 7000,
  range: 2,
...
export const ABILITY_VOID_DRAIN: AbilityDefinition = {
  ...
  description: 'Siphon life force from the target, dealing damage and restoring 25 health.',
  category: 'offensive',
  energyCost: 24,
  cooldownMs: 10000,
  range: 2,
  ...
  effects: [
    ...
    { type: 'heal', baseHeal: 25, scaling: 0.6 },
  ],
...
export const ABILITY_CRYO_BLAST: AbilityDefinition = {
  ...
  description: 'Unleash a burst of cryogenic energy. Deals Cryo damage, effective against heat-adapted creatures.',
  category: 'offensive',
  energyCost: 20,
  cooldownMs: 6000,
  range: 2,
...
export const ABILITY_OVERLOAD_PULSE: AbilityDefinition = {
  ...
  description: 'Release an overwhelming energy surge, damaging all creatures within 2 tiles.',
  category: 'offensive',
  energyCost: 30,
  cooldownMs: 12000,
  range: 2,
...
export const ABILITY_PRECISION_SHOT: AbilityDefinition = {
  ...
  description: 'Fire a precisely targeted shot at extreme range. Reveals stealthed predators in a 6-tile cone for 5 seconds.',
  category: 'offensive',
  energyCost: 18,
  cooldownMs: 5000,
  range: 4,
  requiresTarget: true,
  effects: [
    { type: 'damage', baseDamage: 24, scaling: 1.0 },
    { type: 'reveal', radiusTiles: 6, coneDegrees: 90, durationMs: 5000 },
  ],
...
export const ABILITY_MAGNETIC_FIELD: AbilityDefinition = {
  ...
  description: 'Generate a protective magnetic field that reflects 30% of incoming damage for 8 seconds.',
  category: 'defensive',
  energyCost: 20,
  cooldownMs: 15000,
  range: 0,
...
export const ABILITY_EMERGENCY_SHIELD: AbilityDefinition = {
  ...
  range: 0,
  requiresTarget: false,
  effects: [{ type: 'shield', absorbAmount: 80, durationMs: 8000 }],
...
export const ABILITY_REGENERATION_PROTOCOL: AbilityDefinition = {
  ...
  description: 'Initialize cellular regeneration protocols, restoring 80 HP over 10 seconds.',
  category: 'defensive',
  energyCost: 22,
  cooldownMs: 18000,
  range: 0,
