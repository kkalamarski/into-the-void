...
export function creatureToPlayerDist(creature: Creature, player: PlayerPublic): number {
 ...
 */
export function tickWander(creature: Creature, collisionMap: boolean[][]): AiTickResult {
